package com.codefoundrysl.ar.sqliteexample.database;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addProduct(Product contact) {
        ...
        values.put(KEY_THUMB, contact.getThumbnail()); // Contact Phone
    ...
    public Product getProduct(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_ID,
                        KEY_NAME, KEY_DES, KEY_PRICE, KEY_THUMB}, KEY_ID + "=?",
    ...
    public List<Product> getAllContacts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setThumbnail(cursor.getString(4));
    ...
    public int updateContact(Product product) {
        ...
        values.put(KEY_THUMB, product.getThumbnail());
